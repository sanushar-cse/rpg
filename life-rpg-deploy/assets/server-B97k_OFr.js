import { n as csrfSymbol, t as createCsrfMiddleware } from "./createCsrfMiddleware-f-2zZAGW.js";
import "react";
...
import { createRawStreamRPCPlugin, createSerializationAdapter, defaultSerovalPlugins, executeRewriteInput, getScriptPreloadAttrs, getStylesheetHref, isNotFound, isRedirect, isResolvedRedirect, makeSerovalPlugin, resolveManifestAssetLink, resolveManifestCssLink, rootRouteId } from "@tanstack/router-core";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-B2WuNVoV.js");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CxfRQt79.js"),
		import("./start-YDQvSi77.js"),
